...
class DoctorStatsTab extends GetView<DoctorStatsController> {
          ...
          return ListView(
            ...
            children: [
              ...
              _buildMetricsGrid([
                _MetricData(
                  title: 'نشطون',
                  value: '${controller.activePatients}',
                  icon: Icons.verified_user_rounded,
                  color: AppColors.doctorAccentGreen,
                ),
                _MetricData(
                  title: 'قيد المراجعة',
                  value: '${controller.pendingPatients}',
                  icon: Icons.hourglass_top_rounded,
                  color: AppColors.doctorAccentOrange,
                ),
                _MetricData(
                  title: 'غير نشطين',
                  value: '${controller.inactivePatients}',
  ...
  Widget _buildWeekChart() {
    ...
    final maxCount = counts.fold<int>(0, (a, b) => math.max(a, b));
  ...
  Widget _buildAppointmentStatus() {
    final items = [
      ('مكتملة', controller.completedAppointmentsCount, AppColors.doctorAccentGreen),
      ('قيد الانتظار', controller.pendingAppointmentsCount, AppColors.primary),
      ('متأخرة', controller.lateAppointmentsCount, AppColors.error),
    ];
